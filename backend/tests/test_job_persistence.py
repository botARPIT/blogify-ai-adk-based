...
class TestJobPersistence:
    ...
    @pytest.mark.asyncio
    async def test_generate_creates_session_in_db(self, mock_db_session):
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_generate_creates_budget_ledger_entry(self, mock_db_session):
        ...
        with patch(
            ...
            repo = BudgetRepository(mock_db_session)
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_idempotency_key_prevents_duplicate_session(self, mock_db_session):
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_idempotency_key_none_creates_new_session(self, mock_db_session):
