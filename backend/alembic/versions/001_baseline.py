...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('QUEUED', 'PROCESSING', 'AWAITING_OUTLINE_REVIEW', 'AWAITING_FINAL_REVIEW', 'COMPLETED', 'FAILED', 'CANCELLED', name='blogsessionstatus', native_enum=False), nullable=False),
    ...
    sa.Column('status', sa.Enum('STARTED', 'COMPLETED', 'FAILED', name='agentrunstatus', native_enum=False), nullable=False),
    ...
    op.create_index('ix_research_sources_session', 'research_sources', ['blog_session_id'], unique=False)
    op.create_index('ix_research_sources_user', 'research_sources', ['user_id'], unique=False)
    ...
    op.create_index('ix_session_leases_session', 'session_leases', ['blog_session_id'], unique=False)
    op.create_index('ix_session_leases_started', 'session_leases', ['started_at'], unique=False)
    op.create_table('session_reservations',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('blog_session_id', sa.Integer(), nullable=False),
    sa.Column('reserved_usd', sa.Numeric(precision=12, scale=8), nullable=False),
    sa.Column('reserved_tokens', sa.Integer(), nullable=False),
    sa.Column('actual_usd', sa.Numeric(precision=12, scale=8), nullable=False),
    sa.Column('actual_tokens', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'COMMITTED', 'RELEASED', name='reservationstatus', native_enum=False), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['blog_session_id'], ['blog_sessions.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['auth_users.id'], ),
    ...
    op.create_index('ix_session_reservations_session', 'session_reservations', ['blog_session_id'], unique=False)
    op.create_index('ix_session_reservations_user', 'session_reservations', ['user_id'], unique=False)
    ...
    sa.Column('entry_type', sa.Enum('GRANT', 'RESERVE', 'COMMIT', 'RELEASE', 'ADJUSTMENT', name='budgetentrytype', native_enum=False), nullable=False),
