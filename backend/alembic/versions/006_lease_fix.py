...
def downgrade() -> None:
    op.drop_index("ix_budget_ledger_tenant_resource_day", table_name="budget_ledger_entries")
    op.drop_index("ix_budget_ledger_session_resource_entry", table_name="budget_ledger_entries")
    op.drop_index("ix_budget_ledger_end_user_resource_day", table_name="budget_ledger_entries")
